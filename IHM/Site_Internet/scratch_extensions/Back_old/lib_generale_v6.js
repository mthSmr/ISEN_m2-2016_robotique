...
(function(ext) {
    ...
    *============================================================================*/
        ...
        //  COULEURS
        'blanc','rouge','vert','bleu','turquoise','orange','gris','jaune','magenta','violet'
        var blanc = 1,
            rouge = 2,
            vert = 3,
            bleu = 4,
    ...
    *============================================================================*/
        ...
        function setColor(couleur){
            var msg = new Uint8Array([START_SYSEX,LED, 3, couleur, END_SYSEX]);
            console.log(msg);
            device.send(msg.buffer);
        }
        ...
        function ledOnOff(etat){
            var msg = new Uint8Array([START_SYSEX,LED, 4, on, END_SYSEX]);
            console.log(msg);
            device.send(msg.buffer);
        }
        ...
        function expression(emotion) {
            var msg = new Uint8Array([START_SYSEX,LED, 4, emotion,END_SYSEX]);
            console.log(msg);
            device.send(msg.buffer);
        }
    ...
    *============================================================================*/
        ...
        ext.playNoteDemiTone = function(octave,note,tone)  {
        ...
        ext.buzzerRythme = function(time)  {
            buzzerRythme(time);
        }
        ...
        ext.buzzerAttente = function(time) {
            buzzerAttente(time);
        }
